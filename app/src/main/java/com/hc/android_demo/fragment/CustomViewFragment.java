...
public class CustomViewFragment extends SimpleRecyclerFragment {
    ...
    private void onClickItemInteractiveElements() {
        startContentActivity(FragmentConstants.ITEM_INTERACTIVE);
    }

    private void onClickEmojiTestFragment() {
        startContentActivity(FragmentConstants.EMOJI_TEST_FRAGMENT);
    }
    ...
    private void onClickRippleDrawable() {
        startContentActivity(FragmentConstants.RIPPLE_DRAWABLE_FRAGMENT);
    }
